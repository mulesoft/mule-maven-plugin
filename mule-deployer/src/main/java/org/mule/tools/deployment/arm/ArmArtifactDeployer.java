...
public class ArmArtifactDeployer implements ArtifactDeployer {
  ...
  public ApplicationMetadata getApplicationMetadata() throws DeploymentException {
    try {
      return new ApplicationMetadata(deployment.getArtifact(), deployment.getApplicationName(),
                                     deployment.getTargetType(),
   ...
   * 
   * @return If set in the deployment configuration, the failIfNotExists property
  ...
  /**
   * Deploys the application specified in the {@link Deployment} to ARM through
   * the {@link ArmClient}.
   *
   * @throws DeploymentException
   */
  ...
  /**
   * Undeploys the application specified in the {@link Deployment} to ARM through
   * the {@link ArmClient}.
   *
   * @throws DeploymentException
   */
  ...
  /**
   * Redeploys the application specified in the {@link Deployment} to ARM through
   * the {@link ArmClient}.
   *
   * @throws DeploymentException
   */
