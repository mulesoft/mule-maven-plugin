...
public class ApplicationMetadata {
  ...
  public ApplicationMetadata(CloudHubDeployment deployment) {
    this.setName(deployment.getApplicationName())
        ...
        .setWorkers(deployment.getWorkers())
  ...
  public ApplicationMetadata setMuleVersion(String muleVersion) {
  ...
  public void updateValues(Application currentApplication) {
    ...
    muleVersion = muleVersion == null ? currentApplication.muleVersion : muleVersion;
