...
public class RequestBuilderTest {
  ...
  public void setUp() throws DeploymentException {
    ...
    when(runtimeFabricClientMock.getDomainInfo(anyString())).thenReturn(new Gson().toJsonTree(domains).getAsJsonArray());
    when(runtimeFabricClientMock.getTargetInfo(anyString())).thenReturn(new Gson().fromJson(TARGET_RESPONSE, JsonObject.class));
