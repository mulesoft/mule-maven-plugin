...
class ClassLoaderModelTest {
  ...
  void checkNullVersionTest() {
    assertThatThrownBy(() -> new ClassLoaderModel(null, artifactCoordinates))
        .isExactlyInstanceOf(IllegalArgumentException.class);
  }

  @Test
  void checkNullArtifactCoordinatesTest() {
    assertThatThrownBy(() -> new ClassLoaderModel(VERSION, null))
        .isExactlyInstanceOf(IllegalArgumentException.class);
  }

  @Test
  void checkNullArgumentsTest() {
    assertThatThrownBy(() -> new ClassLoaderModel(null, null))
        .isExactlyInstanceOf(IllegalArgumentException.class);
  }
}
