...
String APPLICATION = "/cloudhub/api/applications/maven-plugin-cloudhub-undeploy-test";
...
while (repeat > 0 && !undeployed)
{
    ...
    application = applications.find { it.domain == 'maven-plugin-cloudhub-undeploy-test' }
