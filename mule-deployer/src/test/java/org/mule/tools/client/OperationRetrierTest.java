...
public class OperationRetrierTest {
  ...
  public void retryFail() throws TimeoutException, InterruptedException {
    ...
    operationRetrier.retry(new DummyRetriableOperation(true));
  }
  ...
  public void retrySucceed() throws TimeoutException, InterruptedException {
    ...
    operationRetrier.retry(new DummyRetriableOperation(false));
  }
  ...
  private class DummyRetriableOperation implements RetriableOperation {

    private final boolean value;

    public DummyRetriableOperation(boolean value) {
      this.value = value;
    }
