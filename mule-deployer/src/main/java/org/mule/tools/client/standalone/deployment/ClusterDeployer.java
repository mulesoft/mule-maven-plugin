...
public class ClusterDeployer {/* extends Deployer { */
  ...
  private void waitForDeployments() throws DeploymentException {
    for (MuleProcessController m : mules) {
      ...
      try {
        new PollingProber(getDeploymentTimeout(),
                          DEFAULT_POLLING_DELAY)
  ...
  public Long getDeploymentTimeout() {
    Long deploymentTimeout = clusterDeployment.getDeploymentTimeout();
    return deploymentTimeout != null ? deploymentTimeout : DEFAULT_CLUSTER_DEPLOYMENT_TIMEOUT;
  }
}
